...
export class BaidugamePlugin implements plugins.Command {
    ...
    async onFile(file: plugins.File) {
        if (file.extname == '.js') {
            ...
            if (filename == "libs/lib/promise/promise.js" || filename == 'libs/lib/promise/promise.min.js') {
                return null;
            }
            if (filename == 'libs/lib/egret/egret.js' || filename == 'libs/lib/egret/egret.min.js') {
                ...
                let content = file.contents.toString();
                if (
                    filename == "libs/lib/res/res.js" ||
                    filename == 'libs/lib/res/res.min.js' ||
                    filename == 'libs/lib/assetsmanager/assetsmanager.min.js' ||
                    filename == 'libs/lib/assetsmanager/assetsmanager.js'
                ) {
                    content += ";window.RES = RES;"
                }
                if (filename == "libs/lib/eui/eui.js" || filename == 'libs/lib/eui/eui.min.js') {
                    content += ";window.eui = eui;"
                }
                if (filename == 'libs/lib/dragonBones/dragonBones.js' || filename == 'libs/lib/dragonBones/dragonBones.min.js') {
